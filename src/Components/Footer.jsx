    ...
    <footer className="bg-[#001931] text-white">
      <div className="md:flex flex-cols-1 md:justify-between items-start py-10 md:mx-20">
        ...
        <div id="contact" className="mb-7 mx-5">
          ...
          <input
            className="my-3 py-2 px-4 rounded-md text-white outline-none border-1 border-gray-700 w-full"
            type="text"
            placeholder="Enter your email"
          />
          <button className="btn hover:bg-[#0e7a81] bg-gradient-to-l from-pink-500 to-red-500 border-none shadow-none text-white px-4 py-2 rounded-md">
            Subscribe
          </button>
        </div>
      </div>
