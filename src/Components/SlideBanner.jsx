...
const SlideBanner = () => {
  ...
  return (
    <div className="relative bg-gradient-to-br from-indigo-500 via-purple-600 to-pink-500 pt-8 pb-12 mt-8 rounded-2xl shadow-lg border-1 border-pink-700">
      <section className="max-w-6xl mx-auto mt-6 px-4 md:px-0 relative">
        <div className="carousel w-full rounded-2xl overflow-hidden relative">
          ...
          <div id="slide1" className="carousel-item relative w-full">
            <img
              src="https://i.ibb.co.com/k2hrLXz2/slide1.jpg"
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/40 to-transparent flex flex-col justify-center items-center text-center px-6 md:px-16">
              ...
              <button className="bg-pink-500 hover:bg-pink-400 text-white font-semibold px-8 py-3 rounded-full shadow-md transition duration-300">
                Adopt Now 
              </button>
            </div>
          ...
          <div id="slide2" className="carousel-item relative w-full">
            <img
              src="https://i.ibb.co.com/zHJrKQbP/slide2.jpg"
              className="w-full h-60 sm:h-80 md:h-[450px] object-cover"
              alt="Slide 2"
            />
            <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/40 to-transparent flex flex-col justify-center items-center text-center px-6 md:px-16">
          ...
          <div id="slide3" className="carousel-item relative w-full">
            <img
              src="https://i.ibb.co.com/S47SGFvJ/slide3.jpg"
              className="w-full h-60 sm:h-80 md:h-[450px] object-cover"
              alt="Slide 3"
            />
            <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/40 to-transparent flex flex-col justify-center items-center text-center px-6 md:px-16">
