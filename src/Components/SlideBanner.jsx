        ...
        <div className="carousel w-full rounded-2xl overflow-hidden relative">
          ...
          <div id="slide1" className="carousel-item relative w-full">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/40 to-transparent flex flex-col justify-center items-center text-center px-4 sm:px-6 md:px-16">
              ...
              <button className="bg-white dark:bg-gray-700 text-gray-700 dark:text-white font-semibold px-6 sm:px-8 py-2 sm:py-3 rounded-full shadow-md transition duration-300 text-sm sm:text-base">
                Adopt Now
              </button>
            </div>
            ...
            <div
              ...
              className="absolute bottom-4 left-1/2 -translate-x-1/2 cursor-pointer animate-bounce text-white text-4xl"
            >
              <FaArrowAltCircleDown className="text-white dark:text-gray-700" />
            </div>
            ...
            <div className="absolute flex justify-between transform -translate-y-1/2 top-1/2 left-3 right-3">
              <a
                ...
                className="btn btn-circle bg-white/20 hover:bg-gray-700 text-white border-none"
              >
                ❮
              </a>
              <a
